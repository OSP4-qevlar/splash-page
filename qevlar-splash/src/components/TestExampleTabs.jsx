...
const TestExampleTabs = () => {
  ...
  function handleTabClick(tabName, tabId) {
    ...
    setTestSnippet(tabName); //TODO: Replace this with code snippet img

    if (isSelected) {
      //set selected state for just the tab that was clicked
      const newIsSelected = { ...isSelected };
      newIsSelected[tabId] = false;
      setIsSelected(newIsSelected);

      const newClassNames = { ...classNames };
      newClassNames[tabId] = deselectedTab;
      setClassNames(newClassNames);
    }
    else {
      const newIsSelected = { ...isSelected };
      newIsSelected[tabId] = true;
      setIsSelected(newIsSelected);

      const newClassNames = { ...classNames };
      newClassNames[tabId] = selectedTab;
      setClassNames(newClassNames);
    }
  }

  const [testSnippet, setTestSnippet] = useState('Profile');
  ...
  // const [testColumn, setTestColumn]
    ...
    <section>
      ...
      <div className="md:flex">
        <ul className="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
          <li>
            <a onClick={e => handleTabClick(e.target.innerText, e.target.id)} tabId='tab0' className={classNames['tab0']} aria-current="page">
          ...
          <li>
            <a onClick={e => handleTabClick(e.target.innerText, e.target.id)} id='tab1' className={classNames['tab1']}>
          ...
          <li>
            <a onClick={e => handleTabClick(e.target.innerText, e.target.id)} id='tab2' className={classNames['tab2']}>
          ...
          <li>
            <a onClick={e => handleTabClick(e.target.innerText, e.target.id)} id='tab3' className={classNames['tab3']}>
              <svg className="w-4 h-4 me-2 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          <li>
            <a onClick={e => handleTabClick(e.target.innerText, e.target.id)} id='tab4' className={classNames['tab4']}>
              <svg className="w-4 h-4 me-2 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M7.824 5.937a1 1 0 0 0 .726-.312 2.042 2.042 0 0 1 2.835-.065 1 1 0 0 0 1.388-1.441 3.994 3.994 0 0 0-5.674.13 1 1 0 0 0 .725 1.688Z" />
                <path d="M17 7A7 7 0 1 0 3 7a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3h1a1 1 0 0 0 1-1V7a5 5 0 1 1 10 0v7.083A2.92 2.92 0 0 1 12.083 17H12a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1a1.993 1.993 0 0 0 1.722-1h.361a4.92 4.92 0 0 0 4.824-4H17a3 3 0 0 0 3-3v-2a3 3 0 0 0-3-3Z" />
              </svg>
