      ...
      <div className="flex justify-center items-center snap-center content-center">
        <div className="sm:flex max-w-screen-xl justify-center items-center">  
          <ul className="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
            ...
            <li>
              <a onClick={e => handleTabClick(e.target.id)} id='tab1' className={activeTab === "tab1" ? selectedTab : deselectedTab}>
            ...
            <li>
              <a onClick={e => handleTabClick(e.target.id)} id='tab2' className={activeTab === "tab2" ? selectedTab : deselectedTab}>
            ...
            <li>
              <a onClick={e => handleTabClick(e.target.id)} id='tab3' className={activeTab === "tab3" ? selectedTab : deselectedTab}>
                <svg className="w-4 h-4 me-2 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
