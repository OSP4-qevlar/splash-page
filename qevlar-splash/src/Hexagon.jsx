...
import {Mesh, Shape, Vector3, BufferGeometry, ExtrudeGeometry, LineSegments, WireframeGeometry, LineBasicMaterial} from 'three';
...
return (
  <>
    ...
    <mesh ref={hexRef} geometry={geometry}  rotation={[0,0,0]}>
      <meshBasicMaterial color={'#FFFFFF'} transparent opacity={0.10}  wireframe />
    </mesh>
  </>
);
